...
- By Lagrange's theorem, $k$ divides the order of $G$, which is $\phi(n)$
...
It follows then that $g^n = e$, where $n$ is the order of a group.
...
* Therefore, $N$ must share factors with $(s-1)$ and $(s+1)$
