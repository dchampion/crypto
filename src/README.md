...
The code above creates two files: `ec_key.der`, a passphrase&ndash;protected [DER](https://en.wikipedia.org/wiki/X.690#DER_encoding) (_Distinguished Encoding Rules_) file containing both the private and public keys, and `ec_public_key.pem`, a [PEM](https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail) (_Privacy&ndash;Enhanced Mail_) file containing just the public key.
